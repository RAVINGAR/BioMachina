...
fun TextComponent.Builder.callback(hoverValue: ComponentLike, onClick: (Player) -> Unit) : TextComponent.Builder {
    this.hoverEvent(HoverEvent.showText(hoverValue))
...
fun TextComponent.Builder.callback(hoverValue: String, onClick: (Player) -> Unit) : TextComponent.Builder {
    return callback(Component.text(hoverValue), onClick)
}